  ...
  return (
    <div className="text-center contenedorSemaforo">
      <div className="video-lluvia">
        <img
          src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExdWk5c3N2Z3VtYmw3N3ZuMmoyYzltbzlidmRjeWNqb2doY2d1Y3FmMSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/UVTMFrWQBsRyctpP0R/giphy.gif"
          alt="Lluvia"
        />
      </div>
      ...
      <h1 className="text-center mt-5">
        <span className="border-bottom border-warning text-white">
          Traffic Light!
        </span>
      </h1>
      ...
      <div className="d-flex flex-column justify-content-center align-items-center semaforo">
        <div
          onClick={() => {
            if (primerRender) turnRed();
          }}
          className={`rojo circle my-1 ${color === "red" ? "active1" : ""}`}
        ></div>
        <div
          onClick={() => {
            if (primerRender) turnYellow();
          }}
          className={`amarillo circle my-1 ${
            color === "yellow" ? "active2" : ""
          }`}
        ></div>
        <div
          onClick={() => {
        ...
        <div
          ...
          className={`purple circle ${
            visible ? "purpleVisible" : "purpleInvisible"
          } ${color === "purple" ? "active4" : ""}`}
        ></div>
      </div>
      <div className="d-flex justify-content-center">
        <button
          disabled={!primerRender}
          className="btn btn-dark my-5 mx-1"
          onClick={() => {
            clearInterval(intervalo);
            setColor("red");
